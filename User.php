...
<body>
  ...
  <div class="centered-menu">
    <a class="nav-link larger-font" href="revise.php"><i class="fa-solid fa-gear"></i>&nbsp;設定&nbsp;&nbsp;</a>
    <a class="nav-link larger-font" href="Shopping.php"><i
        class="fa-solid fa-cart-shopping"></i>&nbsp;購物車&nbsp;&nbsp;</a>
    <a class="nav-link larger-font" href="Orders.php"><i
        class="fa-solid fa-rectangle-list"></i>&nbsp;歷史訂單&nbsp;&nbsp;</a>
    <a class="nav-link larger-font" href="user_coupon.php"><i
        class="fa-sharp fa-solid fa-ticket"></i>&nbsp;優惠券&nbsp;&nbsp;</a>
    <a class="nav-link larger-font" href="logout.php"><i
        class="fa-solid fa-right-from-bracket"></i>&nbsp;登出&nbsp;&nbsp;</a><br>
  </div>
