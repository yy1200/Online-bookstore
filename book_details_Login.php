...
<body>
    ...
    if (isset($_GET['isbn'])) {
        ...
        if ($result && mysqli_num_rows($result) > 0) {
            ...
            echo '<a href="#" class="btn btn-success" onclick="addToCart(event)"><i class="fa-solid fa-cart-shopping">&nbsp;添加到購物車</i></a>';
            echo '<a href="shopping.php" class="btn btn-primary"><i class="fa-solid fa-cash-register">&nbsp;直接購買</i></a>';
            echo '</div>';
