...
<html>
    ...
    <form name="form" method="post" action="manager_book_a_f.php">
                name: <input type="text" name="name"/><br/>
                author: <input type="text" name="author"/><br/>
                format: <input type="text" name="format"/><br/>
                book_depository_stars: <input type="text" name="book_depository_stars"/><br/>
                price: <input type="text" name="price"/><br/>
                currency: <input type="text" name="currency"/><br/>
                old_price: <input type="text" name="old_price"/><br/>
