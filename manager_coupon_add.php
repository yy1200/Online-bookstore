...
<html>
  ...
  /* 设置表单容器的样式 */
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
                <form name="form" method="post" action="manager_coupon_a_f.php">
                    coupon_name: <input type="text" name="coupon_name" /><br>
                    coupon_code: <input type="text" name="coupon_code"/><br/>
                    ...
                    valid_from: <input type="date" name="valid_from"/><br/>
                    valid_to: <input type="date" name="valid_to"/><br/>
