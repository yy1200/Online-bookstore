...
<html>
    ...
    <body>
          ...
          <div class="move_right">
            ...
            <form name="form" method="post" action="manager_coupon_search.php">
                <select name="search_attribute" class="my_select">
                    <option value="coupon_ID">coupon_ID</option>
                    <option value="coupon_name">coupon_name</option>
          ...
          <a href="manager_coupon.php">返回</a> 
          </div>
          <br>         
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM coupon WHERE $search_attribute LIKE '%$search_query%' ";
    ...
    while($row = mysqli_fetch_row($result))
	{
		...
		<tr>
          ...
          <td>$validf</td>
          <td>$validt</td>
          <td><a href='manager_coupon_update_copy.php?coupon_ID=$couponid'>修改</a></td>
          <td><a href='manager_coupon_delete_copy.php?table=".urlencode('coupon')."&coupon_ID=$couponid' onclick=\"return confirm('確定要刪除這筆資料嗎？')\">刪除</a></td>
    	</tr>";
	}
