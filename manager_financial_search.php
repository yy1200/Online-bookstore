...
<html>
    ...
    <body>
          ...
          <div class="move_right">
            ...
            <form name="form" method="post" action="manager_financial_search.php">
                <select name="search_attribute" class="my_select">
                    <option value="financial_ID">financial_ID</option>
          ...
          <a href="manager_financial.php">返回</a>
          </div>  
          <br>         
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM Financial WHERE $search_attribute LIKE '%$search_query%'";
