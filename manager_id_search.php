...
<html>
    ...
    <body>
          ...
          <form name="form" method="post" action="manager_id_search.php">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT user_ID,username,password FROM users WHERE $search_attribute LIKE '%$search_query%' and `role` like  'admin' ";
	...
	while($row = mysqli_fetch_row($result))
	{
		...
		<tr>
      	  ...
      	  <td>$username</td>
          <td>$mask_password</td>
          <td><a href='manager_id_update_copy.php?user_ID=$user_ID'>更改密碼</a></td>
          <td><a href='manager_id_delete_copy.php?table=".urlencode('users')."&user_ID=$user_ID' onclick=\"return confirm('確定要刪除這筆資料嗎？')\">刪除帳戶</a></td>
    	</tr>";
	}
    }
}
