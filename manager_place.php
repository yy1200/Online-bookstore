...
<html>
    ...
    <body>
                    ...
                    <div class="container-fluid">
                         ...
                         <div class="collapse navbar-collapse" id="navbarNav">
                              <ul class="navbar-nav ml-auto">
                                   ...
                                   <li class="nav-item">
                                        <a class="nav-link" href="logout.html" target="_blank">登出</a>
                                   </li>
                              </ul>
                         </div>
                    </div>
          ...
          <div class="move_right">
            ...
            <form name="form" method="post" action="manager_place_search.php">
                <select name="search_attribute" class="my_select">
                    ...
                    <option value="store_address">store_address</option>
                </select>
          ...
          <a href="manager_place_add.php" >新增</a>  
          </div>
          <br>     
...
//因此要給予排除
    ...
    //將資料庫裡的所有會員資料顯示在畫面上
	$sql = "SELECT * FROM convenient_store ORDER BY store_code";
...
echo "<table border='1'>
      ...
      while ($row = mysqli_fetch_row($result)) {
        ...
        <tr>
          ...
          <td>$storeName</td>
          <td>$storeAddress</td>
          <td><a href='manager_place_update_copy.php?table=".urlencode('convenient_store')."&store_code=$storeCode ' >修改</a></td>
          <td><a href='manager_place_delete_copy.php?table=".urlencode('convenient_store')."&store_code=$storeCode' onclick=\"return confirm('確定要刪除這筆資料嗎？')\">刪除</a></td>
        </tr>";
    }
