...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$sql = "UPDATE Shipping SET shipping_method= '$shipping_method' WHERE shipping_ID=$shipping_ID ";
    ...
    $sql = "SELECT * FROM Shipping WHERE shipping_ID=$shippingID";
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
        ...
        shipping_ID: <?php echo $row['shipping_ID']; ?><br>
        shipping_method: <input type="text" name="shipping_method" value="<?php echo $row['shipping_method']; ?>"><br>
