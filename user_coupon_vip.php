...
//因此要給予排除
    ...
    //將資料庫裡的所有會員資料顯示在畫面上
    $sql = "SELECT c.coupon_code, c.discount, c.valid_from, c.valid_to, c.coupon_ID
    FROM users u
    JOIN coupon c ON u.vip_user = c.vip_user
...
echo "<table border='1'>
      ...
      while ($row = mysqli_fetch_row($result)) {
        ...
        <tr>
          ...
          <td>$valid_from</td>
          <td>$valid_to</td>
          <td><a href='user_coupon_add.php?coupon_ID=$coupon_ID'>領取</a></td>
        </tr>";
    }
